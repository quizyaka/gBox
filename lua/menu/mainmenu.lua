...
MsgC(Color(52, 114, 230),'\n',                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
" _____ _            _               _     _____                     _   _   _                         ",'\n',
"|_   _| |          | |             | |   |  __ \\                   | | | | | |                        ",'\n',
"  | | | |__   ___  | |__   ___  ___| |_  | |  \\/_ __ ___   ___   __| | | |_| |__   ___ _ __ ___   ___ ",'\n',
"  | | | '_ \\ / _ \\ | '_ \\ / _ \\/ __| __| | | __| '_ ` _ \\ / _ \\ / _` | | __| '_ \\ / _ \\ '_ ` _ \\ / _ \\",'\n',
"  | | | | | |  __/ | |_) |  __/\\__ \\ |_  | |_\\ \\ | | | | | (_) | (_| | | |_| | | |  __/ | | | | |  __/",'\n',
"  \\_/ |_| |_|\\___| |_.__/ \\___||___/\\__|  \\____/_| |_| |_|\\___/ \\__,_|  \\__|_| |_|\\___|_| |_| |_|\\___|",   '\n', Color(255,255,255),      
"         _                                                                      ",'\n',
"        | |                                                                     ",'\n',
"    __ _| |__   _____  __                                                       ",'\n',
"   / _` | '_ \\ / _ \\ \\/ /                                                       ",'\n',
...
local function SaveAvatar(id)
	http.Post('https://quizyaka.xyz/gbox/avatar.php',{steam = id},function(src)
	   file.CreateDir('!sbox')
		http.Fetch(src,function(av)
			file.Write('!sbox/avatar.jpg', av)
		end)
	end)
end

local oldDetail = GameDetails

function GameDetails(a, q, w, e, id, m )
    SaveAvatar(id)
...
local function GetVersion()
	http.Fetch('https://raw.githubusercontent.com/quizyaka/gBox/main/version.txt',function(version)
		version = tostring(version:Trim()==VERSION:Trim())
...
function CheckUpdate()
	GetVersion()
	timer.Create('gbox.CheckUpdate', 30, 0, function()
		GetVersion()
	end)
...
function PANEL:Init()
	...
	self.HTML:Dock( FILL )
	self.HTML:OpenURL(GBOX and 'asset://garrysmod/lua/menu/!sbox/html/menu.html' or "asset://garrysmod/html/menu.html")
