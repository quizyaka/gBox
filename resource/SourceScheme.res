...
Scheme
{
	...
	Colors
	{
		...
		"TransparentBlack"	"36 37 38 0" // in frame 
		"Black"				"0 0 0 255"

		"Blank"				"0 0 0 0"

		"GMod_BG_Opaque"	"36 37 38 250" // Frame main background ( outline ) 
	...
	BaseSettings
	{
		...
		Border.Subtle					"80 80 80 0" // border in frame

		Button.TextColor				"255 255 255 255"
		Button.BgColor					"57 103 199 255" // buttons
		Button.ArmedTextColor			"46 114 178 255" // text on buttons
		...
		Frame.OutOfFocusBgColor			"36 37 38 200"	[$WIN32] // after animation 
		...
		ListPanel.TextBgColor				"White"
		ListPanel.BgColor					"GMod_BG_Opaque"
		...
		ScrollBarButton.FgColor				"60 60 60 0" // scroll btn
		ScrollBarButton.BgColor				"207 207 207 0"
		...
		ScrollBarSlider.FgColor				"70 70 71 255"			// slider background
		ScrollBarSlider.BgColor				"47 47 47 229"	// slider background color
		...
		SectionedListPanel.BgColor			"GMod_BG_Opaque" // options background
		...
		TextEntry.TextColor			"163 163 163 255"
		TextEntry.BgColor			"55 55 56 125" // text entry background
		TextEntry.CursorColor		"163 163 163 255"
		...
		MainMenu.Inset				"32"
		MainMenu.Backdrop			"0 0 0 25" // background on open esc
	...
	Fonts
	{
		...
		"Default"
		{
			"1"
			{
				"name"		"Roboto Medium" [$WINDOWS]  // font for btns and textentry
				"name"		"Verdana" [!$WINDOWS]
				"tall"		"13"
				"weight"	"500"
				"antialias" "1"
		...
		"DefaultSmall"
		{
			"1"
			{
				"name"		"Roboto Mono Medium" [$WINDOWS]
				"name"		"Verdana" [!$WINDOWS]
				"tall"		"12" [$WINDOWS]
				"tall"		"14" [$OSX]
				"tall"		"16" [$LINUX]
...
//			}
	...
	CustomFontFiles
	{
		...
		"4" 	"resource/RobotoMono-Medium.ttf"
	}
}
